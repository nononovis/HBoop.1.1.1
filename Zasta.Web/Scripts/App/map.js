function initialize() {
    ...
    function initMarkers(map, markerData) {
        var newMarkers = [],
            marker;
		var image ='../../Images/bano-salons-coiffure-markeur1.png'; 
        for(var i=0; i<markerData.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                    ...
                    if (screen.width <= 970) {
                        var url = "../../Home/getInfoSalonMobile";
                        $.ajax({
                            type: 'GET',
                            url: url,
                            data: {                        
    ...
    markers = initMarkers(map, [
        { latLng: new google.maps.LatLng(46.187741, 3.430176), address: "<center> 30 € <br><img src= '../../Images/hour-glass.png' /><br> 0 min</center>", state: ""},
        { latLng: new google.maps.LatLng(47.287741, 4.430176), address: "<center> 20 €<br> <img src= '../../Images/hour-glass.png' /><br> 90 min</center>", state: "" },
        { latLng: new google.maps.LatLng(46.300741, 5.430176), address: "<center> 50 €<br> <img src= '../../Images/hour-glass.png' /><br> 300 min</center>", state: "" },
        { latLng: new google.maps.LatLng(46.087741, 1.430176), address: "<center> 10 €<br> <img src= '../../Images/hour-glass.png' /><br> 40 min</center>", state: "" },
        { latLng: new google.maps.LatLng(46.500741, 4.430176), address: "<center> 60 € <br><img src= '../../Images/hour-glass.png' /><br> 10 min</center>", state: "" },
        { latLng: new google.maps.LatLng(46.800741, 4.430176), address: "<center> 120 € <br><img src= '../../Images/hour-glass.png' /><br> 0 min</center>", state: "" }
    ]);
}